...
function tick(IF,DE,EX,MA,WB){
	...
	console.log("IF", IF.bufferHold.values);
	console.log("DE", DE.bufferHold.values);
	console.log("EX", EX.bufferHold.values);
	console.log("MA", MA.bufferHold.values);
...
function initProgram(){
	...
	var EX = new execute(DE.bufferEX, [new arithBlock(1), new arithBlock(2)]);
