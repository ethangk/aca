...
function initProgram(){
	...
	reservationStations.init([new reservationStation("art"),  new reservationStation("art"), new reservationStation("art"),new reservationStation("lsu"),new reservationStation("art"), new reservationStation("lsu"), new reservationStation("brc")]);
