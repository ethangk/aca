...
var labels 	= {};
var config 	= {	instructionLength: 4 , debug: false, reservationStationBufferSize: 3, reorderBufferSize: 20, issueWidth: 3};
...
function initProgram(){
	...
	reservationStations.init([new reservationStation("art"),  new reservationStation("art"), new reservationStation("lsu"),new reservationStation("art"), new reservationStation("lsu"), new reservationStation("brc")]);
